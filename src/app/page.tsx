          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              <h1 className="text-5xl lg:text-7xl font-light text-gray-900 mb-8 leading-tight">
                WebGen AI Demo Landing
                <span className="block text-primary font-medium mt-2">Intelligence Artificielle</span>
              </h1>
            </motion.div>
            ...
            >
              Plateforme révolutionnaire de génération automatique de sites web propulsée par IA
            </motion.p>
      ...
      <footer className="bg-gray-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-light mb-4">WebGen AI Demo Landing</h2>
            <p className="text-gray-400 mb-8">Intelligence Artificielle</p>
            <div className="pt-8 border-t border-gray-800">
              <p className="text-gray-500">&copy; 2025 WebGen AI Demo Landing. Tous droits réservés.</p>
            </div>
          </div>
        </div>
      </footer>
